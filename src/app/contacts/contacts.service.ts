...
export class ContactsService {
  ...
  getContacts(): Observable<Contact[]> {
    if (this.useMocks) {
      ...
      contacts.push(
        new Contact('telegram', 'Telegram', 'https://t.me/+14084803600')
      );
      contacts.push(
        new Contact('whatsapp', 'Whatsapp', 'https://wa.me/+14084803600')
      );
      contacts.push(
        new Contact(
          'email',
      ...
      return this.http.get<Contact[]>(this.baseUrl + this.url);
    }
  }
}
