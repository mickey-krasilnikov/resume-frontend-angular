  ...
  getCertificates(): Observable<Certification[]>  {
    if (this.useMocks) {
      const certification: Certification[] = [
        ...
        new Certification('fa79fbf3-184f-4a49-a94e-d59fbf4a9b43', 'Azure DevOps Engineer Expert', 'Microsoft', 'microsoft', new URL('https://www.credly.com/badges/eaedb35f-5ea9-45b2-b551-acad69b94488'), new Date(2020, 11, 10), new Date(2023, 11, 10)),
        ...
        new Certification('092b2834-b406-4c92-81d0-8714e53efa5b', 'GCP Professional Cloud Architect', 'Google', 'google', new URL('https://www.credential.net/786961ad-0225-4bb0-883a-3c2feceb5174'), new Date(2020, 9, 27), new Date(2022, 9, 27)),
        new Certification('6d2f85ed-6cd8-4fdf-b2a6-fde4611e998d', 'GCP Associate Cloud Engineer', 'Google', 'google', new URL('https://www.credential.net/f4054913-d10c-4cd4-89cb-e286f00de2ae'), new Date(2020, 8, 29), new Date(2023, 8, 29))
      ];
