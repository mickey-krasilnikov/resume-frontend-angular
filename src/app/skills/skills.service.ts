...
export class SkillsService {
  ...
  getCertificates(): Observable<Skill[]> {
    if (this.useMocks) {
      const Skills: Skill[] = [
        new Skill(
          '798110c8-7669-4c96-a90c-98b6aee4277c',
          'Backend',
          'C#',
          '.NET/.NET Core'
        ),
        new Skill(
          '4ffbcf85-b370-4c3c-80b0-520fe788f382',
          'Backend',
          'GoLang',
          'Gin'
        ),
        new Skill(
          '5a4e4364-9190-48d3-8296-3c4de88376ff',
          'Backend',
          'JavaScript'
        ),
        new Skill(
          'b7e4006f-8f82-411f-ba40-7f2459b50f43',
          'Backend',
          'TypeScript'
        ),
        new Skill('13db1758-3b82-45ea-8fcf-9af828c0a309', 'Backend', 'Python'),
        new Skill(
          'a4d4125c-8733-426c-9329-675513f71ad5',
          'Frontend',
          'Angular'
        ),
        new Skill('d79d128f-6513-40b7-a792-7205c2e77650', 'Frontend', 'Vue.js'),
        new Skill(
          'fe59ff92-4c7c-40d5-9819-2daac4373850',
          'Frontend',
          'ASP.NET'
        ),
        new Skill(
          '40c9e6dc-71d0-4037-a675-3aa94106ce94',
          'Frontend',
          'JavaScript'
        ),
        new Skill(
          '49ea45f5-d672-4c92-a5fd-e5b38575d47f',
          'Frontend',
          'TypeScript'
        ),
        ...
        new Skill(
          '705d5b4a-b417-41ea-9210-06c7abca1f7b',
          'Database',
          'T-SQL',
          'MS SQL'
        ),
        new Skill(
          '73d6a8e4-8451-4f9c-bda8-149c10c4a793',
          'Database',
          'SQL/PSM',
          'MySQL'
        ),
        new Skill(
          '298cd55d-f293-4ad1-95d5-e822295590fa',
          'Database',
          'PL-SQL',
          'PostgreSQL, Oracle'
        ),
        new Skill(
          '482b225f-347e-4000-bc08-1ccd486e37ea',
          'Database',
          'MongoDB'
        ),
        new Skill(
          '6d981847-f2f6-40c6-8ad3-2e323e216210',
          'Database',
          'CosmosDB'
        ),
        new Skill(
          '5b54c66d-4a52-4f13-959e-c5954685435b',
          'Database',
          'DynamoDB'
        ),
        ...
        new Skill(
          '19fadc6b-a7d1-4465-a2a7-41008ae6209e',
          'Tools',
          'Kubernetes'
        ),
        new Skill(
          'e5c381ef-69c4-4796-9d4e-92e43bb00e13',
          'Tools',
          'Azure DevOps'
        ),
        new Skill(
          '8bcce18a-6a87-464a-aead-931b72d435e1',
          'Tools',
          'GitHub Actions'
        ),
        new Skill(
          '8934a0cb-a365-4a93-aa07-0c35d98627e2',
          'Tools',
          'AWS CodePipeline'
        ),
      ...
      return this.http.get<Skill[]>(this.baseUrl + this.url);
    }
  }
}
